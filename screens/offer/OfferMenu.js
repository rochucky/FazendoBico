  ...
  render() {
    return (
        <Layout style={styles.container}>
          <Text style={{backgroundColor: Colors.secondary}}>O que você está oferecendo?</Text>
          <TouchableOpacity key={1} onPress={this.select.bind(this, 'OfferServico')} style={styles.option}>
